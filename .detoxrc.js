...
module.exports = {
  ...
  apps: {
    ...
    'android.debug': {
      ...
      build: 'cd example/android ; ENTRY_FILE=index.js ./gradlew assembleDebug assembleAndroidTest -DtestBuildType=debug ; cd -',
      reversePorts: [
        8081
      ]
    },
    'android.release': {
      ...
      build: 'cd example/android ; ENTRY_FILE=index.js ./gradlew assembleRelease assembleAndroidTest -DtestBuildType=release ; cd -'
    }
  },
  devices: {
    simulator: {
