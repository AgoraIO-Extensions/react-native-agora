 ...
 *
 * @param maxCountThe maximum number of streams that a user can receive within a specified audio reception range.
 */
 ...
 *
 * @param rangeThe maximum audio reception range. The unit is meters. The value must be greater than 0.
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 * @param unitThe number of meters that the game engine distance per unit is equal to. This parameter must be greater than 0.00. For example, setting unit as 2.00 means the game engine distance per unit equals 2 meters.The larger the value is, the faster the sound heard by the local user attenuates when the remote user moves far away from the local user.
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 * @param positionThe coordinates in the world coordinate system. This parameter is an array of length 3, and the three values represent the front, right, and top coordinates in turn.
 * @param axisForwardThe unit vector of the x axis in the coordinate system. This parameter is an array of length 3, and the three values represent the front, right, and top coordinates in turn.
 * @param axisRightThe unit vector of the y axis in the coordinate system. This parameter is an array of length 3, and the three values represent the front, right, and top coordinates in turn.
 * @param axisUpThe unit vector of the z axis in the coordinate system. This parameter is an array of length 3, and the three values represent the front, right, and top coordinates in turn.
 */
 ...
 *
 * @param playerIdThe ID of the media player. 
 * @param positionInfoThe spatial position of the media player. See RemoteVoicePositionInfo .
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 * @param muteWhether to stop publishing the local audio stream.true: Stop publishing the local audio stream.false: Publish the local audio stream.
 */
 ...
 *
 * @param muteWhether to stop subscribing to the audio streams of all remote users:true: Stop subscribing to the audio streams of all remote users.false: Subscribe to the audio streams of all remote users.
 */
 ...
 *
 * @param uidThe user ID. This parameter must be the same as the user ID passed in when the user joined the channel.
 * @param posInfoThe spatial position of the remote user. See RemoteVoicePositionInfo .
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
