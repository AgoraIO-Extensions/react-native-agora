...
type AudioStateWithUidCallback = (uid: number, state: AudioRemoteState, reason: AudioRemoteStateReason, elapsed: number) => void
type VideoStateWithCallback = (uid: number, state: VideoRemoteState, reason: VideoRemoteStateReason, elapsed: number) => void
...
type onAudioMixingStateChanged = (state: AudioMixingStateCode, errorCode: AudioMixingErrorCode) => void
