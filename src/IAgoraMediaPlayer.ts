 ...
 *
 * @param uriThe URI (Uniform Resource Identifier) of the media file.
 * @param startPosThe starting position (ms) for playback. The default value is 0.
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 * @param sourceMedia resources. See MediaSource .
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 * @param newPosThe new playback position (ms).
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 * @param indexThe index of the media stream.
 *
 * @returns
 ...
 *
 * @param loopCountThe number of times the audio effect loops:
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 * Call this method after calling open .
 *
 * @param speedThe playback speed. Agora recommends that you limit this value to between 50 and 400, defined as follows:50: Half the original speed.100: The original speed.400: 4 times the original speed.
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 *
 * @param muteWhether to mute the media file:true: Mute the media file.false: (Default) Unmute the media file.
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 *
 * @param volumeThe local playback volume, which ranges from 0 to 100:0: Mute.100: (Default) The original volume.
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 * @param volumeThe volume, which ranges from 0 to 400:0: Mute.100: (Default) The original volume.400: Four times the original volume (amplifying the audio signals by four times).
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 *
 * @param renderModeSets the render mode of the view. See RenderModeType .
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 *
 * @param observerThe player observer, listening for events during the playback. See IMediaPlayerSourceObserver .
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 * @param modeThe channel mode. See AudioDualMonoMode .
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 * @param indexThe index of the CDN routes.
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 * @param enableWhether to enable the automatic switch of the CDN routes for playing the media resource:true: Enables the automatic switch of the CDN routes.false: (Default) Disables the automatic switch of the CDN routes.
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 * @param tokenThe authentication field. See the sign field of the authentication information.
 * @param tsThe timestamp when the authentication information expires. See the ts field of the authentication information.
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 * @param srcThe URL of the media resource.
 * @param startPosThe starting position (ms) for playing after the media resource is preloaded to the playlist. When preloading a live stream, set this parameter to 0.
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 * @param srcThe URL of the media resource in the playlist must be consistent with the src set by the preloadSrc method; otherwise, the media resource cannot be played.
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 * @param observerThe audio frame observer, reporting the reception of each audio frame. See IMediaPlayerAudioFrameObserver .
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 *
 * @param observerThe audio observer. See IMediaPlayerAudioFrameObserver .
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 * @param observerThe video observer, reporting the reception of each video frame. See IMediaPlayerVideoFrameObserver .
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 * @param keyThe key of the option.
 * @param valueThe value of the key.
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 * The cached media file currently being played will not be deleted.
 *
 * @param uriThe URI (Uniform Resource Identifier) of the media file to be deleted.
 *
 * @returns
 * 0: Success.
 *  < 0: Failure. See MediaPlayerError .
 ...
 *
 * @param pathThe absolute path of the media files to be cached. Ensure that the directory for the media files exists and is writable.
 *
 * @returns
 * 0: Success.< 0: Failure. See MediaPlayerError .
 */
 ...
 *
 *
 * @param countThe maximum number of media files that can be cached. The default value is 1,000.
 *
 * @returns
 * 0: Success.
 *  < 0: Failure. See MediaPlayerError .
 ...
 *
 *
 * @param cacheSizeThe maximum size (bytes) of the aggregate storage space for cached media files. The default value is 1 GB.
 *
 * @returns
 * 0: Success.
 *  < 0: Failure. See MediaPlayerError .
 ...
 *
 * @param enableWhether to enable the SDK to delete cached media files automatically:true: Delete cached media files automatically.false: (Default) Do not delete cached media files automatically.
 *
 * @returns
 * 0: Success.< 0: Failure. See MediaPlayerError .
 */
 ...
 *
 * @param lengthAn input parameter; the maximum length of the cache file storage path string. 
 *
 * @returns
