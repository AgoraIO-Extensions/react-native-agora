 ...
 * @param callbackThe callbacks for recording local audio and video streams. See IMediaRecorderObserver .
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 * @param connectionThe connection information. See RtcConnection .
 * @param configThe recording configuration. See MediaRecorderConfiguration .
 *
 * @returns
