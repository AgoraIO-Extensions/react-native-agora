...
export class IMediaEngineImpl implements IMediaEngine {
  ...
  pushAudioFrame (type: MediaSourceType, frame: AudioFrame, wrap: boolean = false, sourceId: number = 0): number {
  ...
  protected getApiTypeFromPushAudioFrame (type: MediaSourceType, frame: AudioFrame, wrap: boolean = false, sourceId: number = 0): string {
  ...
  protected getApiTypeFromSetExternalVideoSource (enabled: boolean, useTexture: boolean, sourceType: ExternalVideoSourceType = ExternalVideoSourceType.VideoFrame, encodedVideoOption: SenderOptions = new SenderOptions()): string {
    return 'MediaEngine_setExternalVideoSource'
  }

  setExternalAudioSource (enabled: boolean, sampleRate: number, channels: number, sourceNumber: number = 1, localPlayback: boolean = false, publish: boolean = true): number {
  ...
  protected getApiTypeFromSetExternalAudioSource (enabled: boolean, sampleRate: number, channels: number, sourceNumber: number = 1, localPlayback: boolean = false, publish: boolean = true): string {
  ...
  setDirectExternalAudioSource (enable: boolean, localPlayback: boolean = false): number {
  ...
  protected getApiTypeFromSetDirectExternalAudioSource (enable: boolean, localPlayback: boolean = false): string {
  ...
  protected getApiTypeFromPushVideoFrame (frame: ExternalVideoFrame, videoTrackId: number = 0): string {
    return 'MediaEngine_pushVideoFrame'
  }

  pushEncodedVideoImage (imageBuffer: Uint8Array, length: number, videoEncodedFrameInfo: EncodedVideoFrameInfo, videoTrackId: number = 0): number {
  ...
  protected getApiTypeFromPushEncodedVideoImage (imageBuffer: Uint8Array, length: number, videoEncodedFrameInfo: EncodedVideoFrameInfo, videoTrackId: number = 0): string {
