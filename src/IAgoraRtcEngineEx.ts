 ...
 *
 *
 * @param connectionThe connection information. See RtcConnection .
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 * @param connectionThe connection information. See RtcConnection .
 * @param canvasThe remote video view settings. See VideoCanvas .
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 *
 * @param connectionThe connection information. See RtcConnection .
 * @param uidThe ID of the specified user.
 * @param muteWhether to stop receiving the audio stream of the specified user:true: Stop receiving the audio stream of the specified user.false: (Default) Resume receiving the audio stream of the specified user.
 *
 * @returns
 * 0: Success. < 0: Failure.
 */
 ...
 * @param muteWhether to stop receiving the video stream of the specified user:true: Stop receiving the video stream of the specified user.false: (Default) Resume receiving the video stream of the specified user.
 *
 * @returns
 * 0: Success.< 0: Failure.
 */
 ...
 * @param connectionThe connection information. See RtcConnection .
 * @param uidNumberThe number of users in the user ID list.
 * @param uidListThe user ID list of users that you want to subscribe to.
 ...
 * @param connectionThe connection information. See RtcConnection .
 * @param uidNumberThe number of users in the user ID list.
 * @param uidListThe user ID list of users that you do not want to subscribe to.
 ...
 * @param connectionThe connection information. See RtcConnection .
 * @param uidThe user ID of the remote user.
 * @param panThe voice position of the remote user. The value ranges from -1.0 to 1.0:-1.0: The remote voice comes from the left.0.0: (Default) The remote voice comes from the front.1.0: The remote voice comes from the right.
 ...
 *
 * @param connectionThe connection information. See RtcConnection .
 * @param streamIdThe data stream ID. You can get the data stream ID by calling createDataStreamEx.
 ...
 *
 * @param filePathThe local path (including filename extensions) of the snapshot. For example:
